...
namespace EliteEnemies.Affixes.Behaviors
{
    ...
    public class HardeningBehavior : AffixBehaviorBase, ICombatAffixBehavior, IUpdateableAffixBehavior
    {
        ...
        private static readonly float DurationMaxHardened = 10f;  // 满层持续时间
        ...
        private void ApplyPhysicsFactorChange(CharacterMainControl character)
        {
            ...
            var physicsStat = character.CharacterItem.GetStat(StatKeys.ElementFactor_Physics);
            ...
            if (finalReduction > 0.001f)
            {
                ...
                Modify(character, StatKeys.ElementFactor_Physics, 1.0f - finalReduction, true);
            }
        }
